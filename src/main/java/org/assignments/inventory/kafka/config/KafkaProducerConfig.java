package org.assignments.inventory.kafka.config;
...
public class KafkaProducerConfig {
    ...
    @Value("${kafka.topics.inventory-check-requested}")
    private String inventoryCheckRequestedTopic;
    ...
    @Bean
    public NewTopic inventoryCheckRequestedTopic() {
        return TopicBuilder.name(inventoryCheckRequestedTopic)
                .partitions(3)
                .replicas(1)
                .build();
    }
    ...
    public NewTopic inventoryCheckResultTopic() {
        return TopicBuilder.name(inventoryCheckResultTopic)
                .partitions(3)
                .replicas(1)
                .build();
    }
